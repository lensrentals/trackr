...
//line tracking_numbers.go.rl:17
...
//line tracking_numbers.go:72
	{
	cs = tracking_number_start
	}

//line tracking_numbers.go:77
	{
	if p == pe {
		goto _test_eof
	}
	...
	goto st_out
tr16:
//line tracking_numbers.go.rl:193
...
//line tracking_numbers.go:216
		...
		goto st0
tr1:
//line tracking_numbers.go.rl:192
 wordStart = p 
//line tracking_numbers.go.rl:67
 fe.sum = 0 
//line tracking_numbers.go.rl:65
 fe.sum += 3*(int(data[p]) - '0') 
//line tracking_numbers.go.rl:81
 fg.sum = 0 
//line tracking_numbers.go.rl:79
 fg.sum += 1*(int(data[p]) - '0') 
//line tracking_numbers.go.rl:114
 uss128.sumA = 0; uss128.sumB = 0 
//line tracking_numbers.go.rl:115
...
//line tracking_numbers.go.rl:80
 fg.sum += 3*(int(data[p]) - '0') 
//line tracking_numbers.go.rl:116
...
//line tracking_numbers.go:281
		...
		goto st0
tr6:
//line tracking_numbers.go.rl:66
...
//line tracking_numbers.go.rl:82
...
//line tracking_numbers.go.rl:126
	...
	goto st22
tr58:
//line tracking_numbers.go.rl:99
	...
	goto st22
tr70:
//line tracking_numbers.go.rl:168
...
//line tracking_numbers.go:948
		...
		goto st0
tr30:
//line tracking_numbers.go.rl:96
 ups.sum += 2*(int(data[p]) - '0') 
	goto st27
tr31:
//line tracking_numbers.go.rl:97
...
//line tracking_numbers.go:1484
		...
		goto st0
tr65:
//line tracking_numbers.go.rl:146
...
//line tracking_numbers.go:1507
		...
		goto st0
tr66:
//line tracking_numbers.go.rl:147
...
//line tracking_numbers.go:1530
		...
		goto st0
tr67:
//line tracking_numbers.go.rl:148
...
//line tracking_numbers.go:1553
		...
		goto st0
tr68:
//line tracking_numbers.go.rl:149
...
//line tracking_numbers.go:1709
		}
	}

	}

//line tracking_numbers.go.rl:221
